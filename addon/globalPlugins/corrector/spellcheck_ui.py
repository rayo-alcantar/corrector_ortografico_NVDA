...
SCRCAT__SPELLCHECK = _("Corrector Ortográfico")
...
class MisspellingMenuItemObject(MenuItemObject):
    ...
    def on_user_choice(self, choice):
        ...
        if choice.choice_type is UserChoiceType.SUGGESTION:
            ...
            desc = _("Añadido al diccionario personal")
        else:
        ...
        menu_items.extend(
            [
                SuggestionMenuItemObject(
                    ...
                    name=_("Ignorar para esta sesión"),
                    **common_kwargs,
                ),
                SuggestionMenuItemObject(
                    choice_type=UserChoiceType.ADD_TO_PERSONAL_DICTIONARY,
                    # translators: name of the option in the suggestion menu.
                    name=_("Añadir al diccionario"),
                    **common_kwargs,
                ),
            ]
        )
    ...
    @script(
        ...
        description=_("Copia el texto corregido al portapapeles"),
    ...
    @script(
        ...
        # translators: appears in the NVDA input help.
        description=_("Reemplaza el texto en el campo de edición con el texto corregido"),
        category=SCRCAT__SPELLCHECK,
    )
    ...
    def ignore_for_this_session(self, item):
        ...
        if self:
            ...
            queueHandler.queueFunction(
                queueHandler.eventQueue, ui.message, _("No hay errores ortográficos")
            )
            self.close_menu()
    ...
    def replace_text(self):
        ...
        if is_readonly:
            ...
            queueHandler.queueFunction(
                ...
                ui.message,
                _("No se puede reemplazar el texto, el campo de texto es de solo lectura"),
            )
            queueHandler.queueFunction(
