# Corrector ortográfico es un addon para corregir palabras mal escritas en un texto.
# Este archivo está cubierto por la Licencia Pública General de GNU.
# Consulta el archivo COPYING para más detalles.
# Última actualización 2026
# Derechos de autor (C) 2026 Ángel Alcántar <rayoalcantar@gmail.com>
...
class donate:
    ...
    def request():
        ...
        message = _("""Corrector_ortográfico- complemento gratuito para NVDA.
